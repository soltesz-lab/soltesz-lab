var CCKADIFCN = function() {	
	...
	if (document.getElementById("CCKADIChart") && document.getElementById("CCKADI").style.display!="hidden" && document.getElementById("CCKADI").style.display!="none") {
	jQuery('#CCKADIChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
