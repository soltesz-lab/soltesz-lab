var CCKBasketFCN = function() {	
	...
	if (document.getElementById("CCKBasketChart") && document.getElementById("CCKBasket").style.display!="hidden" && document.getElementById("CCKBasket").style.display!="none") {
	jQuery('#CCKBasketChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
