var CB1RFCN = function() {	
	...
	window.cck = Math.round(window.nNOSNPYpyramidale/10)*10;

	
	if (document.getElementById("CB1RChart") && document.getElementById("CB1R").style.display!="hidden" && document.getElementById("CB1R").style.display!="none") {
	jQuery('#CB1RChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
    title:{
        text:'CB1R expression with CCK (TBA)'
    },
