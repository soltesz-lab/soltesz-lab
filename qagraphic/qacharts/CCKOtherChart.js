var CCKOtherFCN = function() {	
	...
	if (document.getElementById("CCKOtherChart") && document.getElementById("CCKOther").style.display!="hidden" && document.getElementById("CCKOther").style.display!="none") {
	jQuery('#CCKOtherChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
