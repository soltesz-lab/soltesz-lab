var PVSOFCN = function() {	
	...
	if (document.getElementById("PVSOChart") && document.getElementById("PVSO").style.display!="hidden" && document.getElementById("PVSO").style.display!="none") {
	jQuery('#PVSOChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
