var PVRatioFCN = function() {	
	...
	if (document.getElementById("PVRatioChart") && document.getElementById("PVRatio").style.display!="hidden" && document.getElementById("PVRatio").style.display!="none") {
	jQuery('#PVRatioChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
