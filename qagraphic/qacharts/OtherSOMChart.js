var OtherSOMFCN = function() {	
	...
	if (document.getElementById("OtherSOMChart") && document.getElementById("OtherSOM").style.display!="hidden" && document.getElementById("OtherSOM").style.display!="none") {
	jQuery('#OtherSOMChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
