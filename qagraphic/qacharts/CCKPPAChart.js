var CCKPPAFCN = function() {	
	...
	if (document.getElementById("CCKPPAChart") && document.getElementById("CCKPPA").style.display!="hidden" && document.getElementById("CCKPPA").style.display!="none") {
	jQuery('#CCKPPAChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
