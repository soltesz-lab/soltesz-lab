var PVLaminarFCN = function() {	
	...
	if (document.getElementById("PVLaminarChart") && document.getElementById("PVLaminar").style.display!="hidden" && document.getElementById("PVLaminar").style.display!="none") {
	jQuery('#PVLaminarChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
