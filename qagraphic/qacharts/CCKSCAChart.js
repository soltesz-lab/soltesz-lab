var CCKSCAFCN = function() {	
	...
	if (document.getElementById("CCKSCAChart") && document.getElementById("CCKSCA").style.display!="hidden" && document.getElementById("CCKSCA").style.display!="none") {
	jQuery('#CCKSCAChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
