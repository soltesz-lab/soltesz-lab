var PVFCN = function() {	
	...
	if (document.getElementById("PVChart") && document.getElementById("PV").style.display!="hidden" && document.getElementById("PV").style.display!="none") {
	jQuery('#PVChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
