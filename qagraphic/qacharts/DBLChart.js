var DBLFCN = function() {	
	...
	if (document.getElementById("DBLChart") && document.getElementById("DBL").style.display!="hidden" && document.getElementById("DBL").style.display!="none") {
	jQuery('#DBLChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
