var ORIFCN = function() {	
	...
	if (document.getElementById("ORIChart") && document.getElementById("ORI").style.display!="hidden" && document.getElementById("ORI").style.display!="none") {
	jQuery('#ORIChart').highcharts({
    chart: {
        renderTo:'container',
        type:'scatter'
    },
